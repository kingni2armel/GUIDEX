...
<div class="page-container">
    <div class="main-content">
        <h3 class="title-5 m-b-35">&nbsp &nbsp Modifier un client</h3>
                    <div class="col-lg-10">
                        <div class="card">
                            <div class="card-header">Formulaire de modification d'un client</div>
                            ...
                            <div class="card-body card-block">
                                            @foreach ($infotier as $data )
                                                                    <form action="{{route('UPDATECLIENT',['id'=>$_GET['id']])}}" method="post" class="">
